Program allows for searching for recipes based on their name, cooking time, or the name of an ingredient. The program reads the recipes from a file that the user provides. 
